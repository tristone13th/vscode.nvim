...
theme.load_syntax = function()
    ...
    local syntax = {
        ...
        Typedef = { c.condFg, nil, 'none', nil },
        Special = { c.importFg, nil, 'none', nil },
        ...
        TSString = { c.commentFg, nil, 'none', nil },
        TSCharacter = { c.commentFg, nil, 'none', nil },
        TSNumber = { c.numFg, nil, 'none', nil },
        TSBoolean = { c.numFg, nil, 'none', nil },
        TSFloat = { c.numFg, nil, 'none', nil },
        TSAnnotation = { c.commentFg, nil, 'none', nil },
        TSAttribute = { c.vscFront, nil, 'none', nil },
        TSNamespace = { c.vscBlueGreen, nil, 'none', nil },
        TSFuncBuiltin = { c.functionFg, nil, 'none', nil },
        TSFunction = { c.functionFg, nil, 'none', nil },
        TSFuncMacro = { c.vscYellow, nil, 'none', nil },
        TSParameter = { c.paraFg, nil, 'italic', nil },
        TSParameterReference = { c.paraFg, nil, 'italic', nil },
        TSMethod = { c.functionFg, nil, 'none', nil },
        TSField = { c.vscFront, nil, 'none', nil },
        TSProperty = { c.vscFront, nil, 'none', nil },
        TSConstructor = { c.functionFg, nil, 'none', nil },
        TSConditional = { c.condFg, nil, 'none', nil },
        TSRepeat = { c.repeatFg, nil, 'none', nil },
        TSLabel = { c.vscLightBlue, nil, 'none', nil },
        TSKeyword = { c.condFg, nil, 'none', nil },
        TSKeywordFunction = { c.keywordFg, nil, 'italic', nil },
        TSKeywordOperator = { c.opFg, nil, 'none', nil },
        TSOperator = { c.opFg, nil, 'none', nil },
        TSException = { c.vscPink, nil, 'none', nil },
        TSType = { c.typeFg, nil, 'none', nil },
        TSTypeBuiltin = { c.vscBlue, nil, 'none', nil },
        TSStructure = { c.vscLightBlue, nil, 'none', nil },
        TSInclude = { c.importFg, nil, 'none', nil },
        ...
        -- Lua
        luaFuncCall = { c.functionFg, nil, 'none', nil },
